...
Public Class SewaFutsal
    ...
    End Sub
    Sub no()
        Dim getID As String = "SELECT max(id) FROM tbfutsal"
    ...
    Sub tampil()
        ...
        DS.Clear()
        DA.Fill(DS, "tbfutsal")
        DataGridView1.DataSource = DS.Tables("tbfutsal")
    ...
    Private Sub btnPesan_Click(sender As Object, e As EventArgs) Handles btnPesan.Click
        ...
        If txtnama.Text = "" Or txtharga.Text = "" Or txtjam.Text = "" Or txtnohp.Text = "" Or Cbhari.Text = "" Or gbJam.Text = "" Then
            ...
            txtnama.Focus()
        Else
            CMD = New MySqlCommand("Select * From tbfutsal where nama='" & txtnama.Text & "'", CONN)
            RD = CMD.ExecuteReader
            RD.Read()
            RD.Close()
            If Not RD.HasRows Then
                Dim save As String = "insert into 
                tbfutsal(id,nama,nohp,totaljam,hari,jam,totalharga)values 
                 ('" & txtid.Text & "'
                 ,'" & txtnama.Text & "',
                 '" & txtnohp.Text & "',
                 '" & txtjam.Text & "',
    ...
    Sub hitungjam()
        ...
        txtjam.Text = jumlah
    End Sub
    Private Sub SewaFutsal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        koneksi()
        tampil()
        AturGrid()
        For Each cb In gbJam.Controls.OfType(Of CheckBox)()
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        If txtnama.Text = "" Or txtnohp.Text = "" Or txtjam.Text = "" Or Cbhari.Text = "" Or txtharga.Text = "" Then
            ...
            txtnama.Focus()
        Else
            Dim Ubah As String = "UPDATE tbfutsal SET nama = '" & txtnama.Text & "',
                                nohp = '" & txtnohp.Text & "', 
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        Else
            If MessageBox.Show("Apakah anda ingin menghapus data ini ? " &
                ...
                CMD = New MySqlCommand("Delete From tbfutsal Where nama = '" & txtnama.Text & "'", CONN)
                CMD.ExecuteNonQuery()
                Call bersih()
                Call tampil()
            Else
    ...
    Private Sub printDocument1_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        e.Graphics.DrawString("Sewa Lapangan Futsal", f, br, 300, 200)
